-- s04: posts.user_id int8 (no change) but add a numeric column to test type widening later.
-- Type change scenario: full_name text → varchar(200) preserving default.
